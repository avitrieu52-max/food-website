...
<div class="d-flex justify-content-between align-items-center mb-4">
    <h3 class="mb-0"><i class="fas fa-plus me-2"></i>Thêm quy tắc phí vận chuyển</h3>
        ...
        <form action="{{ route('admin.shipping.store') }}" method="POST">
            ...
            <div class="row g-3">
                <div class="col-md-6">
                    ...
                    <input type="text" name="name" value="{{ old('name') }}" class="form-control" required placeholder="VD: Miễn phí vận chuyển">
                </div>
                <div class="col-md-3">
                    <label class="form-label fw-semibold">Đơn hàng tối thiểu (đ) <span class="text-danger">*</span></label>
                    <input type="number" name="min_order_value" value="{{ old('min_order_value', 0) }}" class="form-control" min="0" required>
                </div>
                <div class="col-md-3">
                    <label class="form-label fw-semibold">Phí vận chuyển (đ) <span class="text-danger">*</span></label>
                    <input type="number" name="fee" value="{{ old('fee', 0) }}" class="form-control" min="0" required>
                    <small class="text-muted">Nhập 0 = miễn phí</small>
                </div>
                <div class="col-12">
                ...
                <div class="col-12 mt-2">
                    <button type="submit" class="btn btn-success px-5"><i class="fas fa-save me-2"></i>Lưu quy tắc</button>
                </div>
            </div>
        </form>
    </div>
