...
<div class="d-flex justify-content-between align-items-center mb-4">
    <h3 class="mb-0"><i class="fas fa-edit me-2"></i>Sửa sản phẩm</h3>
        ...
        <form action="{{ route('admin.food.update', $food->id) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="row g-3">
                ...
                <div class="col-md-4">
                    ...
                    <input type="number" name="price" value="{{ old('price', $food->price) }}" class="form-control" min="0" required>
                </div>
                <div class="col-md-4">
                    <label class="form-label fw-semibold">Giá khuyến mãi (đ)</label>
                    <input type="number" name="sale_price" value="{{ old('sale_price', $food->sale_price) }}" class="form-control" min="0">
                </div>
                <div class="col-md-4">
                    <label class="form-label fw-semibold">Tồn kho <span class="text-danger">*</span></label>
                    <input type="number" name="stock" value="{{ old('stock', $food->stock) }}" class="form-control" min="0" required>
                </div>
                <div class="col-12">
                ...
                <div class="col-md-6">
                    ...
                    @if($food->image)
                        <div class="mb-2">
                            <img src="{{ $food->image_url }}" alt="{{ $food->name }}" class="rounded"
                                 style="max-height:120px;" id="imagePreview">
                        </div>
                    @else
                        <img id="imagePreview" src="#" alt="Preview" class="mt-2 rounded d-none mb-2"
                ...
                <div class="col-md-6 d-flex align-items-end gap-4">
                    ...
                    <div class="form-check form-switch">
                        <input class="form-check-input" type="checkbox" name="status" id="status"
                               {{ old('status', $food->status) ? 'checked' : '' }}>
