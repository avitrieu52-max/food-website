...
<div class="d-flex justify-content-between align-items-center mb-4">
    <h3 class="mb-0"><i class="fas fa-plus me-2"></i>Thêm Mã giảm giá</h3>
        ...
        <form action="{{ route('admin.coupon.store') }}" method="POST">
            ...
            <div class="row g-3">
                <div class="col-md-4">
                    ...
                    <input type="text" name="code" value="{{ old('code') }}" class="form-control text-uppercase" required placeholder="VD: SUMMER20">
                </div>
                <div class="col-md-4">
                ...
                <div class="col-md-4">
                    ...
                    <input type="number" name="min_order_value" value="{{ old('min_order_value', 0) }}" class="form-control" min="0">
                </div>
                <div class="col-md-4">
                    <label class="form-label fw-semibold">Số lần dùng tối đa</label>
                    <input type="number" name="max_uses" value="{{ old('max_uses') }}" class="form-control" min="1" placeholder="Để trống = không giới hạn">
                </div>
                <div class="col-md-4">
                ...
                <div class="col-12 mt-2">
                    <button type="submit" class="btn btn-success px-5"><i class="fas fa-save me-2"></i>Lưu mã</button>
                </div>
            </div>
        </form>
    </div>
